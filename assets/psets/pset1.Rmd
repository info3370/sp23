...
- Use this [.Rmd template](http://localhost:4000/assets/psets/pset1.Rmd) to complete the problem set
- If you want to print the assignment, here is a [pdf](http://localhost:4000/assets/psets/pset1.pdf)
